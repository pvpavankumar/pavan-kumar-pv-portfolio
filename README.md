...
Professional portfolio for Venkata Pavan Kumar Pasumarthi, a Staff Frontend Engineer and UI Engineering Leader. Built with Next.js, Tailwind CSS, [Netlify Visual Editor](https://docs.netlify.com/visual-editor/overview/), and the Git Content Source.
...
Import `pvpavankumar/pavan-kumar-pv-portfolio` into Netlify. The included `netlify.toml` contains the project build configuration.
